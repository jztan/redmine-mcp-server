...
- @aadnehovda, contributed the path-aliased discovery endpoints concept via [`codex-dcr-compat`](https://github.com/aadnehovda/redmine-mcp-server/tree/codex-dcr-compat) fork.
